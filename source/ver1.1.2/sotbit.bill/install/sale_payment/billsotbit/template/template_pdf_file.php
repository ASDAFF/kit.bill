	...
	if($params["BUYER_PERSON_COMPANY_NAME_SOTBIT"])
	{
        ...
        else
        {
            ...
            if ($params["BUYER_PERSON_COMPANY_PHONE_SOTBIT"])
                $str.= ','.\Bitrix\Main\Localization\Loc::getMessage("SALE_HPS_BILL_SOTBIT_BUYER_PHONE",array('#PHONE#'=>$params["BUYER_PERSON_COMPANY_PHONE_SOTBIT"]));
            if ($params["BUYER_PERSON_COMPANY_ADDRESS_SOTBIT"])
                $str.= ','.\Bitrix\Main\Localization\Loc::getMessage("SALE_HPS_BILL_SOTBIT_BUYER_ADDRESS",array('#ADDRESS#'=>$params["BUYER_PERSON_COMPANY_ADDRESS_SOTBIT"]));
            if ($params["BUYER_PERSON_COMPANY_FAX_SOTBIT"])
                $str.= ','.\Bitrix\Main\Localization\Loc::getMessage("SALE_HPS_BILL_SOTBIT_BUYER_FAX",array('#FAX#'=>$params["BUYER_PERSON_COMPANY_FAX_SOTBIT"]));
        }
...
$dest = 'F';
$pdfName = BillSotbit::genBillName(
    $order->getId(),
