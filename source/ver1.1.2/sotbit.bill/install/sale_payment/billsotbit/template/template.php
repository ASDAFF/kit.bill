        ...
        <?if($PersonType != 1):?>
            <tr>
                ...
                <td>
                    ...
                    if ($params["BUYER_PERSON_COMPANY_KPP_SOTBIT"])
                    ...
                    if ($params["BUYER_PERSON_COMPANY_PHONE_SOTBIT"])
                        echo ','.\Bitrix\Main\Localization\Loc::getMessage("SALE_HPS_BILL_SOTBIT_BUYER_PHONE",array('#PHONE#'=>$params["BUYER_PERSON_COMPANY_PHONE_SOTBIT"]));
                    if ($params["BUYER_PERSON_COMPANY_ADDRESS_SOTBIT"])
                        echo ','.\Bitrix\Main\Localization\Loc::getMessage("SALE_HPS_BILL_SOTBIT_BUYER_ADDRESS",array('#ADDRESS#'=>$params["BUYER_PERSON_COMPANY_ADDRESS_SOTBIT"]));
                    if ($params["BUYER_PERSON_COMPANY_FAX_SOTBIT"])
                        echo ','.\Bitrix\Main\Localization\Loc::getMessage("SALE_HPS_BILL_SOTBIT_BUYER_FAX",array('#FAX#'=>$params["BUYER_PERSON_COMPANY_FAX_SOTBIT"]));
